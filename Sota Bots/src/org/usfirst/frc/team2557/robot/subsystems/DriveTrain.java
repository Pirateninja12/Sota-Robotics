...
public class DriveTrain extends Subsystem {
    ...
    public void arcadeDrive_Cartesian123(double x,double y,double rotation,double gyroAngle){
    	robotDrive41.arcadeDrive(x, y);
    	//robotDrive41.mecanumDrive_Polar(x, y, rotation);//gyro.getAngle());
    }
   
    public void arcadeDrive_Polar123(double magnitude, double direction, double rotation) {
    	robotDrive41.arcadeDrive(magnitude, direction);	
    }
